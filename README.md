...
The 2016 dataset was stored in a `s3` bucket to make access easier across machines [https://project4-nyctaxi.s3.us-east-1.amazonaws.com/train.csv&#39;]('https://project4-nyctaxi.s3.us-east-1.amazonaws.com/train.csv').
...
Using private data from NYC TLC should be done with careful consideration of ownership. This project will not be monetized in anyway, and therefore falls within fair use. The data was also part of a kaggle competition and was freely made open source.
